...
namespace Ch03Ex02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The result of substracting {secondNumber} from {firstNumber} is {firstNumber - secondNumber}.");
            ...
            Console.WriteLine($"The remainder after diividing {firstNumber} by {secondNumber} is {firstNumber % secondNumber}.");
            Console.ReadKey();
        }
    }
}
